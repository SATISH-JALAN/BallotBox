...
| Midnight network questions | [Midnight docs](https://docs.midnight.network/) |

When reporting a problem, include your wallet (Lace or 1AM) and version, browser, the
exact error text, and the poll address. **Never share your wallet seed or key backup file.**
